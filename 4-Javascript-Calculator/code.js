...
function showSelectedOperator(){
    ...
    for (var i=0; i<elements.length; i++){
        elements[i].style.backgroundColor  = "#2c622c";
    }

    if (operator_value == "+"){
        document.getElementById("plusOp").style.backgroundColor  = "#2c622c";
    }
    else if (operator_value == "-"){
        document.getElementById("subOp").style.backgroundColor  = "#2c622c";
    }
    else if (operator_value == "*"){
        document.getElementById("multiOp").style.backgroundColor  = "#2c622c";
    }
    else if (operator_value == "/"){
        document.getElementById("divOp").style.backgroundColor  = "#2c622c";
    }
}
